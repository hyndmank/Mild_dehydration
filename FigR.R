...
######################### All clusters #########################
### Load Seurat object
load("combined1.RData")

###### Ad lib #######
### Subset Adlib clusters from Seurat object
Adlib <- subset(combined1, subset = groupid == "adlib")
...
head(Adlib_cisCorr)
save(Adlib_cisCorr,file="E:/Van/R/All_Adlib_cisCorr.RData")
write_xlsx(Adlib_cisCorr,"E:\\Van\\R\\All_Adlib_cisCorr.xlsx")

### Filter peak-gene pair with significant association
Adlib_cisCorr.filt <- Adlib_cisCorr %>% filter(pvalZ <= 0.05)
write_xlsx(Adlib_cisCorr.filt,"E:\\Van\\R\\All_Adlib_cisCorr_filtered.xlsx")


############### Dehydrated ###################
### Subset Dehydrated clusters from Seurat object
Deh <- subset(combined1, subset = groupid == "dehydrated")
...
save(Deh_ATAC.se,file="E:/Van/R/Deh_ATAC_se.RData")
...
save(Deh_RNAmat,file="E:/Van/R/Deh_RNAmat.RData")
dim(Deh_RNAmat) # Genes x Cells
...
head(Deh_cisCorr)
save(Deh_cisCorr,file="E:/Van/R/All_Deh_cisCorr.RData")
write_xlsx(Deh_cisCorr,"E:\\Van\\R\\All_Deh_cisCorr.xlsx")

### Filter peak-gene pairs with significant association
Deh_cisCorr.filt <- Deh_cisCorr %>% filter(pvalZ <= 0.05)
write_xlsx(Deh_cisCorr.filt,"E:\\Van\\R\\All_Deh_cisCorr_filtered.xlsx")
...
PC <- subset(combined1, idents = c("CDPC", "CNT-PC"))
save(PC,file="E:/Van/R/PC.RData")

### Subset PC ad lib 
PC_Adlib <- subset(PC, subset = groupid == "adlib")
save(PC_Adlib,file="E:/Van/R/PC_Adlib.RData")

### Subset PC dehydrated
PC_Deh <- subset(PC, subset = groupid == "dehydrated")
save(PC_Deh,file="E:/Van/R/PC_Deh.RData")
...
save(PC_Adlib_cisCorr,file="E:/Van/R/PC_Adlib_cisCorr.RData")
write_xlsx(PC_Adlib_cisCorr,"E:\\Van\\R\\PC_Adlib_cisCorr.xlsx")

### Filter peak-gene pairs with significant association
PC_Adlib_cisCorr.filt <- PC_Adlib_cisCorr %>% filter(pvalZ <= 0.05)
save(PC_Adlib_cisCorr.filt, file="E:/Van/R/PC_Adlib_cisCorr_filt.RData")
write_xlsx(PC_Adlib_cisCorr.filt,"E:\\Van\\R\\PC_Adlib_cisCorr.filtered.xlsx")
...
head(PC_Deh_cisCorr)
save(PC_Deh_cisCorr,file="E:/Van/R/PC_Deh_cisCorr.RData")
write_xlsx(PC_Deh_cisCorr,"E:\\Van\\R\\PC_Deh_cisCorr.xlsx")

### Filter peak-gene pairs with significant association
PC_Deh_cisCorr.filt <- cisCorr %>% filter(pvalZ <= 0.05)
save(PC_Deh_cisCorr.filt, file="E:/Van/R/PC_Deh_cisCorr_filt.RData")
write_xlsx(PC_Deh_cisCorr.filt,"E:\\Van\\R\\PC_Deh_cisCorr.filtered.xlsx")

################## Proximal tubule ###################
### Subset PT Seurat
PT <- subset(combined1, idents = c("fPTS1", "fPTS2", "fPTS2", "mPTS1", "mPTS2", "mPTS3"))
save(PT,file="E:/Van/R/PT.RData")

### Subset PT ad lib 
PT_Adlib <- subset(PT, subset = groupid == "adlib")
save(PT_Adlib,file="E:/Van/R/PT_Adlib.RData")

### Subset PT dehydrated
PT_Deh <- subset(PT, subset = groupid == "dehydrated")
save(PT_Deh,file="E:/Van/R/PT_Deh.RData")
...
save(PT_Adlib_cisCorr,file="E:/Van/R/PT_Adlib_cisCorr.RData")
write_xlsx(PT_Adlib_cisCorr,"E:\\Van\\R\\PT_Adlib_cisCorr.xlsx")

### Filter peak-gene pairs with significant association
PT_Adlib_cisCorr.filt <- PT_Adlib_cisCorr %>% filter(pvalZ <= 0.05)
save(PT_Adlib_cisCorr.filt, file="E:/Van/R/PT_Adlib_cisCorr_filt.RData")
write_xlsx(PT_Adlib_cisCorr.filt,"E:\\Van\\R\\PT_Adlib_cisCorr.filtered.xlsx")
...
### Chose top 50 genes with the highest correlation coefficient (rObs)
